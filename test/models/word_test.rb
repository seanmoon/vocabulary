...
test "creating a word" do
  ...
  word_id = Word.create(user_id: user_id, name: "hola", added_on: "1359470665")
...
test "find by user id" do
  user_id = User.create(username: "sean")
  Word.create(user_id: user_id, name: "hola", added_on: "1359470665")
  Word.create(user_id: user_id, name: "adios", added_on: "1359470665")
...
test "to_attributes" do
  user_id = User.create(username: "sean")
  word_id = Word.create(user_id: user_id, name: "hola", added_on: "1359470665", deleted: "true")
  word = Word.find(word_id)
  attributes = {id: word_id, userId: user_id, name: "hola", addedOn: "1359470665", deleted: "true"}
